...
void Vcache_tb___024root__trace_chg_0_sub_0(Vcache_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgSData(oldp+1,(vlSelfRef.cache_tb__DOT__test_addresses[0]),14);
        bufp->chgSData(oldp+2,(vlSelfRef.cache_tb__DOT__test_addresses[1]),14);
        bufp->chgSData(oldp+3,(vlSelfRef.cache_tb__DOT__test_addresses[2]),14);
        bufp->chgSData(oldp+4,(vlSelfRef.cache_tb__DOT__test_addresses[3]),14);
        bufp->chgSData(oldp+5,(vlSelfRef.cache_tb__DOT__test_addresses[4]),14);
        bufp->chgSData(oldp+6,(vlSelfRef.cache_tb__DOT__test_addresses[5]),14);
        bufp->chgSData(oldp+7,(vlSelfRef.cache_tb__DOT__test_addresses[6]),14);
        bufp->chgSData(oldp+8,(vlSelfRef.cache_tb__DOT__test_addresses[7]),14);
        bufp->chgSData(oldp+9,(vlSelfRef.cache_tb__DOT__test_addresses[8]),14);
        bufp->chgSData(oldp+10,(vlSelfRef.cache_tb__DOT__test_addresses[9]),14);
        bufp->chgSData(oldp+11,(vlSelfRef.cache_tb__DOT__test_addresses[10]),14);
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[1U] 
        ...
        bufp->chgCData(oldp+19,((1U & ((IData)(vlSelfRef.cache_tb__DOT__address) 
                                       >> 3U))),2);
    }
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[2U] 
                      | vlSelfRef.__Vm_traceActivity
                      [4U])))) {
        bufp->chgBit(oldp+20,(vlSelfRef.cache_tb__DOT__stall));
        bufp->chgBit(oldp+21,(vlSelfRef.cache_tb__DOT__data_valid));
        bufp->chgBit(oldp+22,(vlSelfRef.cache_tb__DOT__cache__DOT__next_state));
        bufp->chgBit(oldp+23,(vlSelfRef.cache_tb__DOT__cache__DOT__idle));
        bufp->chgBit(oldp+24,(vlSelfRef.cache_tb__DOT__cache__DOT__replace_en));
    }
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[3U]))) {
        bufp->chgBit(oldp+25,(vlSelfRef.cache_tb__DOT__cache__DOT__curr_state));
        bufp->chgQData(oldp+26,(vlSelfRef.cache_tb__DOT__cache__DOT__mem_out),64);
        bufp->chgBit(oldp+28,(vlSelfRef.cache_tb__DOT__cache__DOT__hit));
        bufp->chgCData(oldp+29,(vlSelfRef.cache_tb__DOT__cache__DOT__cache_data_array__DOT__replace_way),2);
        bufp->chgCData(oldp+30,(vlSelfRef.cache_tb__DOT__cache__DOT__cache_tag_array__DOT__hit_way),2);
        bufp->chgWData(oldp+31,(vlSelfRef.cache_tb__DOT__cache__DOT__cache_data_array__DOT__set_o),192);
        bufp->chgWData(oldp+37,(vlSelfRef.cache_tb__DOT__cache__DOT__cache_data_array__DOT__data_array),384);
        bufp->chgSData(oldp+49,(vlSelfRef.cache_tb__DOT__cache__DOT__cache_tag_array__DOT__tag_array
                                [0U][0U]),10);
        ...
        bufp->chgBit(oldp+72,(vlSelfRef.cache_tb__DOT__cache__DOT__cache_tag_array__DOT__valid_array
                              [3U][2U]));
        bufp->chgCData(oldp+73,(vlSelfRef.cache_tb__DOT__cache__DOT__cache_tag_array__DOT__LRU_array
                                [0U][0U]),2);
        ...
        bufp->chgCData(oldp+84,(vlSelfRef.cache_tb__DOT__cache__DOT__cache_tag_array__DOT__LRU_array
                                [3U][2U]),2);
        bufp->chgCData(oldp+85,(vlSelfRef.cache_tb__DOT__cache__DOT__cache_tag_array__DOT__empty_way),2);
        bufp->chgBit(oldp+86,(vlSelfRef.cache_tb__DOT__cache__DOT__cache_tag_array__DOT__empty_found));
        bufp->chgCData(oldp+87,(vlSelfRef.cache_tb__DOT__cache__DOT__cache_tag_array__DOT__oldest_way),2);
        bufp->chgIData(oldp+88,(vlSelfRef.cache_tb__DOT__cache__DOT__cache_tag_array__DOT__unnamedblk4__DOT__i),32);
        bufp->chgIData(oldp+89,(vlSelfRef.cache_tb__DOT__cache__DOT__cache_tag_array__DOT__unnamedblk5__DOT__i),32);
