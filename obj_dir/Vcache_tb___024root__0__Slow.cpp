...
VL_ATTR_COLD void Vcache_tb___024root___eval_initial__TOP(Vcache_tb___024root* vlSelf) {
    ...
    VL_READMEM_N(false, 22, 11, 0, "test_files/test_address.x"s
    ...
    while (VL_GTS_III(32, 0x0009ca00U, vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT__i)) {
        vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT____Vlvbound_h9cad2051__0 = 0U;
        if (VL_LIKELY(((0x0009c9ffU >= (0x000fffffU 
                                        & vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT__i))))) {
            vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT__main_memory[(0x000fffffU 
                                                                            & vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT__i)] 
                = vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT____Vlvbound_h9cad2051__0;
        }
        vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT__i 
    ...
    while (VL_GTS_III(32, 0x00000093U, vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT__i)) {
        vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT____Vlvbound_h8832fe4e__0 
        ...
        vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT____Vlvbound_h22887a14__0 
        ...
        vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT____Vlvbound_h22386af0__0 
            = (0x000000ffU & (((0x92U >= (0x000000ffU 
                                          & vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT__i))
                                ? vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT__temp_memory
                               [(0x000000ffU & vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT__i)]
        ...
        vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT____Vlvbound_h22377ae3__0 
            = (((0x92U >= (0x000000ffU & vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT__i))
                 ? vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT__temp_memory
                [(0x000000ffU & vlSelfRef.cache_tb__DOT__cache__DOT__memory1__DOT__i)]
                 : 0U) >> 0x18U);
...
#endif
            VL_FATAL_MT("design/fifo_buffer.sv", 10, "", "Settle region did not converge after 100 tries");
        }
...
VL_ATTR_COLD void Vcache_tb___024root___ctor_var_reset(Vcache_tb___024root* vlSelf) {
    ...
    vlSelf->push_data = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 8141005003212623892ull);
    vlSelf->push_pop = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 11877588266294439003ull);
    vlSelf->reset = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9928399931838511862ull);
    vlSelf->clk = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16707436170211756652ull);
    vlSelf->pop_data = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 16659459033433359568ull);
    vlSelf->buffer_full = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14663875713135549949ull);
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->fifo_buffer__DOT__fifo_buffer[__Vi0] = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 2749724021340160033ull);
    }
    vlSelf->fifo_buffer__DOT__head = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 16278370533682829335ull);
    vlSelf->fifo_buffer__DOT__tail = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 13989085349174026633ull);
    vlSelf->fifo_buffer__DOT__empty = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7546054080578156254ull);
    ...
    vlSelf->cache_tb__DOT__cache__DOT__memory_address = VL_SCOPED_RAND_RESET_I(14, __VscopeHash, 3268685585789253527ull);
    ...
    vlSelf->cache_tb__DOT__cache__DOT__curr_state_mem = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13148875291899524935ull);
    vlSelf->cache_tb__DOT__cache__DOT__next_state_mem = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10909316967898117734ull);
    ...
    vlSelf->cache_tb__DOT__cache__DOT__store_en = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9652043890699209921ull);
    ...
    vlSelf->cache_tb__DOT__cache__DOT__memory1__DOT__unnamedblk1__DOT__i = 0;
    vlSelf->cache_tb__DOT__cache__DOT__memory1__DOT__unnamedblk2__DOT__i = 0;
    vlSelf->cache_tb__DOT__cache__DOT__memory1__DOT____Vlvbound_h9cad2051__0 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 14530877867257966575ull);
    vlSelf->cache_tb__DOT__cache__DOT__memory1__DOT____Vlvbound_h8832fe4e__0 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 6951713155442181762ull);
    vlSelf->cache_tb__DOT__cache__DOT__memory1__DOT____Vlvbound_h22887a14__0 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 3753461492586495849ull);
    vlSelf->cache_tb__DOT__cache__DOT__memory1__DOT____Vlvbound_h22386af0__0 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 16049086991443460377ull);
    vlSelf->cache_tb__DOT__cache__DOT__memory1__DOT____Vlvbound_h22377ae3__0 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 11609583946390438758ull);
    vlSelf->cache_tb__DOT__cache__DOT__memory1__DOT____Vlvbound_ha00dc8f6__0 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 9059608013533513581ull);
    ...
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 3; ++__Vi1) {
            vlSelf->cache_tb__DOT__cache__DOT__cache_tag_array__DOT__valid_array[__Vi0][__Vi1] = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 3748721829184432098ull);
        }
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 3; ++__Vi1) {
    ...
    vlSelf->cache_tb__DOT__cache__DOT__cache_tag_array__DOT__unnamedblk5__DOT__i = 0;
    vlSelf->cache_tb__DOT__cache__DOT__cache_tag_array__DOT____Vlvbound_h757dacf1__1 = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 6204342212472621715ull);
    vlSelf->cache_tb__DOT__cache__DOT__cache_tag_array__DOT____Vlvbound_h3d879d0c__0 = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 7523314671299599395ull);
    vlSelf->cache_tb__DOT__cache__DOT__cache_tag_array__DOT____Vlvbound_he009873e__0 = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 11300042101985153841ull);
    vlSelf->cache_tb__DOT__cache__DOT__cache_tag_array__DOT____Vlvbound_hd6a180d5__0 = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 12101778255173210637ull);
    vlSelf->cache_tb__DOT__cache__DOT__cache_tag_array__DOT____Vlvbound_h337ceab6__0 = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 13230022710401431018ull);
    vlSelf->cache_tb__DOT__cache__DOT__cache_data_array__DOT__offset = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 14201588189092293361ull);
    ...
    vlSelf->cache_tb__DOT__cache__DOT__cache_data_array__DOT__temp = VL_SCOPED_RAND_RESET_Q(64, __VscopeHash, 11670439239958985815ull);
    ...
    vlSelf->cache_tb__DOT__cache__DOT__cache_data_array__DOT____Vlvbound_h95e99ec6__0 = VL_SCOPED_RAND_RESET_Q(64, __VscopeHash, 15317930668161094534ull);
