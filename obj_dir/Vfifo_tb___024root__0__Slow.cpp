...
VL_ATTR_COLD void Vfifo_tb___024root___ctor_var_reset(Vfifo_tb___024root* vlSelf) {
    ...
    vlSelf->fifo_tb__DOT__push_data = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 18155016535685620606ull);
    vlSelf->fifo_tb__DOT__push_pop = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 6694179457994192140ull);
    vlSelf->fifo_tb__DOT__pop_data = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 2088823179515181935ull);
    vlSelf->fifo_tb__DOT__buffer_full = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17541744714403905435ull);
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        vlSelf->fifo_tb__DOT__fifo1__DOT__fifo_buffer[__Vi0] = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 11856406222563543953ull);
    }
